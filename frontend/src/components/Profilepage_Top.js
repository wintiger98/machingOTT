...
const OTTLogoImage = {
    ...
    'WATCHA': 'https://upload.wikimedia.org/wikipedia/commons/b/b8/%EC%99%93%EC%B1%A0_%EB%A1%9C%EA%B3%A0_2021.png',
                    ...
                    <div>
                        {
                            customer.OTTName === 'NETFLIX'
                                ? <img style={{display: "inline-block"}} width={400 / 3} height={300 / 3}
                                       src={OTTLogoImage.NETFLIX} alt="NETFLIX Logo Image"/>
                                : (customer.OTTName === 'WATCHA'
                                    ? <img style={{display: "inline-block"}} width={233} height={300 / 3}
                                           src={OTTLogoImage.WATCHA} alt="WATCHA Logo Image"/>
                                    : (customer.OTTName === 'WAVVE'
                                        ? <img style={{display: "inline-block"}} width={350} height={300 / 3}
                                               src={OTTLogoImage.WAVVE} alt="WAVVE Logo Image"/>
                ...
                >
                    ...
                    >
                        <div
                            ...
                            <img src={customer.profileImage} alt="프로필 사진"/>
                        </div>
                    </div>
